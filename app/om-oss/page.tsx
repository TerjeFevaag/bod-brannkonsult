...
export const metadata: Metadata = {
  title: 'Om Bodø Brannkonsult | Sentralt godkjent brannrådgiver',
  description:
    'Bodø Brannkonsult er et sentralt godkjent brannrådgiverfirma med over 1200 prosjekter siden 2013. Vi tilbyr brannkonsept, brannprosjektering og branntilsyn i Bodø og Salten.',
  alternates: { canonical: 'https://www.bodøbrannkonsult.no/om-oss' },
}
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            <ScrollReveal className="lg:w-1/2">
              ...
              <p className="text-brand-darkgray leading-relaxed mb-5">
                Vi er et spesialisert brannprosjekteringsfirma med base i Bodø, og vi tar oppdrag over hele landet. Vår virksomhet har sentral godkjenning for brannprosjektering i tiltaksklasse 1 og 2.
              </p>
              <p className="text-brand-darkgray leading-relaxed mb-5">
              ...
              <p className="text-brand-darkgray leading-relaxed mb-8">
                Bodø har en helt særegen bygningshistorie — store deler av sentrum ble ødelagt under den tyske bombingen i 1940 og bygget opp igjen etter krigen, noe som har gitt byen en blanding av etterkrigsarkitektur og nyere utvikling i områder som Rønvik og Sjøfronten. Byen er også porten til Saltstraumen, verdens sterkeste tidevannsstrøm, og kjent for midnattssolen. Vi hjelper private, arkitekter og utbyggere med brannkonsept og brannprosjektering i hele Bodø og Salten.
              </p>
        ...
        <div className="max-w-[1350px] mx-auto px-4 sm:px-6 lg:px-8">
          <ScrollReveal className="max-w-3xl">
            ...
            <p className="text-brand-darkgray leading-relaxed mb-4">
              Bodø Brannkonsult selger ingen produkter og tilbyr ingen håndverkertjenester. Vi er utelukkende en rådgivende part — det sikrer at rådet vi gir alltid er i ditt beste interesse, og ikke påvirket av salgsinteresser.
            </p>
            ...
            <div className="bg-brand-dark rounded-[30px] p-10 lg:p-16 flex flex-col lg:flex-row items-start lg:items-center justify-between gap-8">
              <div>
                ...
                <div className="space-y-2 text-brand-white/60 text-sm">
                  ...
                  <div className="flex items-center gap-2">
                    <Mail size={14} />
                    <a href="mailto:post@bodøbrannkonsult.no" className="hover:text-brand-orange transition-colors">post@bodøbrannkonsult.no</a>
                  </div>
                  <div className="flex items-center gap-2">
                    <MapPin size={14} />
                    <span>Bodø, Salten</span>
                  </div>
                </div>
              </div>
              <Link
