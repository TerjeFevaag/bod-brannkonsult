...
export const metadata: Metadata = {
  title: 'Riktig røykvarsler redder liv | Bodø Brannkonsult',
  description:
          ...
          <div className="prose prose-lg max-w-none text-brand-darkgray">
            ...
            <ScrollReveal>
              <div className="bg-brand-lightgray rounded-[20px] p-6 mb-8">
                <h3 className="font-bold text-brand-black text-lg mb-3">Anbefaling fra Bodø Brannkonsult</h3>
            ...
            <ScrollReveal>
              ...
              <p className="leading-relaxed">
                ...
                <Link href="/kontakt-oss" className="text-brand-orange font-bold hover:underline">
                  Ta kontakt med Bodø Brannkonsult
                </Link>{' '}
